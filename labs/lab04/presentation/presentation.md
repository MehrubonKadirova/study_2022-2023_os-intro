...
![команда ls](image/функциилс.png){ #fig:002 width=80% }
...
![Создание каталогов letters, memos, misk и из удаление](image/3пункт.png){ #fig:003 width=80% }
...
![Команда man ls](image/4.png){ #fig:004 width=80% }
...
![Выполнение модификации и исполнение команды из буфера обмена](image/72.png){ #fig:005 width=80% }
