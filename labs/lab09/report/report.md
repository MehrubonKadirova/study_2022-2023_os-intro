...
author: "Кадирова Мехрубон Рахматжноновна"
...
![Emacs](image/11.png){#fig:001 width=70%}

2. Создать файл lab07.sh с помощью комбинации Ctrl-x Ctrl-f (C-x C-f) (рис. @fig:002).

![Использование необходимой команды для создания файла](image/1.png){#fig:00 width=70%}

3. Наберите текст (рис. @fig:003).

![Набранный текст](image/2.png){#fig:003 width=70%}
...
![вырезали строку](image/3.png){#fig:001 width=70%}

- 5.2. Вставить эту строку в конец файла (C-y) (рис. @fig:005).

![Вставили строку](image/4.png){#fig:001 width=70%}

- 5.3. Выделить область текста (C-space). Скопировать область в буфер обмена (M-w) (рис. @fig:006).

![Выделили и скопировали область текста в буфер обмена](image/5.png){#fig:006 width=70%}

- 5.4. Вставить область в конец файла (рис. @fig:007).

![Вставили область текста с буфера обмены](image/6.png){#fig:007 width=70%}
...
- 9.5. Испробуйте другой режим поиска, нажав M-s o. Объясните, чем он отличается от
обычного режима? (рис. @fig:016).

![](image/9.5.png){#fig:016 width=70%}
